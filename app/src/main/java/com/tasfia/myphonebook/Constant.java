package com.tasfia.myphonebook;
...
public class Constant {
    ...
    //main url or address
    public static final String MAIN_URL = "http://192.168.43.50";   //IP address

  //  public static final String MAIN_URL = "http://android.cseiiuc.cf"; //bujinai   //hosting
